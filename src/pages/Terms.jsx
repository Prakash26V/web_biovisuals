            ...
            <div>
                        ...
                        <Grid container spacing={0}>
                            <Grid item lg={12} sm={12} md={12} xs={12} >
                                <div className="humhaiabout">
                                    <p className="hero_text ">Terms & Conditions
                                    </p>
                                </div>
                                <div className="structtoo">
                                    <p className="struckp"> Home
                                        / <span className="struct"> Terms & Conditions </span></p>
                                </div>
                ...
                <div style={{ margin: '1rem', }}>
                    ...
                    <div >
                        <Grid container spacing={0}>
                            <Grid item lg={12} sm={12} md={12} xs={12}  >
                                <h2 className="h2about" >BioVisuals - Terms Of Service</h2>
                            </Grid>
                            
                                <div className="termsbg">
                                    <p className="h2term" > Terms Of Service</p>
                                </div>
