...
const IconSubCategories = (props) => {
    ...
    const handleSubCategoriesIcon = async () => {
        try {
          const response = await axios.post(`${base_url}api/user/adminSubCategories`, {_id: categoryId});
    ...
    const filteredCategories = displaySubCategoriesData.filter((category) => {
            ...
            <div style={{ marginTop: '115px'}}>
                ...
                <div style={{ margin: '1rem', }}>
                    <div >
                        ...
                        {/* render subcategories data here with image data */}
                        <Grid container spacing={2}>
                            {filteredCategories.map((subcategory) => (
                                <Grid key={subcategory.id} item lg={3} sm={6} md={6} xs={6}  >
                                    <Link 
                                        // to={`/user/childCategoriesicon`} 
                                        to={`/user/childCategoriesicon/${subcategory._id}`}
                                        className="link"
                                    >
                                        <div className="Buucards">
                                            <div style={{ position: 'relative' }} className="belubee">
                                                <img src={image_url + subcategory.subCategoryImage} className="iconnimagee" />
                                                <p 
                        ...
                        <Grid item lg={6} sm={12} md={12} xs={12}  >
                            <div className="newdocmaindiv">
                                ...
                                <div className="docsinup">
                                    <div>
                                        <Button variant="contained" disableElevation className="customButton" style={{   fontWeight: '600' }}>
                                            Sign Up Free
                                        </Button>
                                    </div>
...
export default IconSubCategories;